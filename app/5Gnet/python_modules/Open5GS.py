...
class Open5GS:
    def __init__(self, mon:MonitorScenario, cp_host_name:str):
        
        cp_host_ip = mon.d_client.containers.get( cp_host_name ).attrs['NetworkSettings']['IPAddress']

        self.server = cp_host_ip
        self.port   = "27017"
            ...
            'session': [
                {
                    ...
                    'pcc_rule': [],
                    'ambr':  {
                        'uplink': {'value': max_thr, 'unit': 2},   # unit=2 ==> Mbps
            ...
            'session': [
                {
                    ...
                    'pcc_rule': [],
                    'ambr':  {
                        'uplink': {'value': 5, 'unit': 2},   # unit=2 ==> Mbps
