...
class Results:
    ...
    def collect_and_save_results( self, redis_cli, mon:MonitorScenario, iperf_app:IperfApp ):
        ...
        self.get_traffic_traces( redis_cli, mon.start_time)
        # self.results["iperf"] = iperf_app.parse_iperf_files(mon.start_sim)
        self.results["iperf"] = iperf_app.parse_redis_udp_results(mon.start_time)
        self.results["iperf"] = iperf_app.parse_redis_tcp_results(mon.start_time)
