#!/bin/bash	
echo -e '\n'
echo "*** Please clear file config.ini ***"
echo "*** with command python3 ./svuota_config.py ***"
echo -e '\n'
echo "*** INSERT IN CONFIG.INI FILE THE FOLLOWING PARAMETERS:  "
echo "1) pcap_file - pcap file address"
echo "2) testbed - umu o cnit "
echo "3) interval - flow analysis time interval in seconds"
echo -e '\n'
sleep 30	
