...
if __name__ == "__main__":
    ...
    # Connects OFSwitches to sFlow (comment if you don't use sFlow)
    ...
    net.addLink(dns_s, s3, bw=100, delay="1ms", intfName1="dns-s-eth1", intfName2="s3-dns")
