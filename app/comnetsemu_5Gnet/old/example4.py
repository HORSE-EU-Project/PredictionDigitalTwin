...
if __name__ == "__main__":
    ...
    #exec(open('../../labs/HORSE/sflow-rt/extras/sflow.py').read())
    env = dict()
    ...
    server = net.addDockerHost('server', dimage="dev_test", ip="192.168.0.200/24", docker_args={"hostname": "server"})
    ...
    net.addLink(server, s3, bw=1000, delay="1ms", intfName1="server-eth0",  intfName2="upf-server")
